                ...
                <div class="row ">
                    ...
                    <div class="col-lg-5 col-md-12 ">
                        <div class="card" style="min-height: 485px">
                            ...
                            // $pack_select = "select * from login where email='$email' limit 2";
                            // $query = mysqli_query($con, $pack_select);
                            // while ($row = mysqli_fetch_array($query)) {
                            //     if ($query) {
                            ...
                            <div class="row mt-3">
                                <form action="" method="post" class="p-5">
                                    <h5 class="text-primary mb-4">Reset Your Password</h5>
                                <div class="mb-3 mt-3">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if ($password === $cpassword) {
                                        ...
                                        $update="UPDATE login SET password='$Password_safe' WHERE email='$email'";
                                        $result = mysqli_query($con, $update);

                                                    if ($result) {
                                ?>
                                                        <script>
                                                            alert("Password Update Successlly");
                                                    ...
                                                    ?>
                                                        <script>
                                                            alert("Password Update Un-Successlly");
                                                        </script>
                                <?php
                                        ...
                                        echo $password . "_Same Password";
                                    } else {
                                        echo $password . "<br>" . $cpassword . "<br>" . "Wrong Password";;
                                    }
                                }
                                ?>
                            </div>
