                                            ...
                                            <table class="table p-3" id="tblData">
                                                <thead>
                                                    ...
                                                    if (isset($_POST['submit'])) {
                                                        ...
                                                        $query = "select * from pakages where Continents = '$Continents' AND email = '$email'";
                                                    ...
                                                    ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="package_update.php?ids=<?php echo $row['ID']; ?>" class="btn btn-primary">Update Pacakge</a> </td>
                                                                </tr>
                                                            <?php
                                                            } else {
                                                                echo "No Request";
                                                        ...
                                                        $email = $_SESSION['email'];
                                                        $query = "select * from pakages WHERE email = '$email'";
                                                        $show = mysqli_query($con, $query);
