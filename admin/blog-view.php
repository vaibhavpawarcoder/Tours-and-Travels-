                                ...
                                <div class="row justify-content-evenly pt-5">
                                    <div class="col-md-11">
                                        <form class="row gy-2 gx-3 justify-content-evenly" method="POST">
                                            <div class="col-md-4">
                                                <?php
                                                $query = "SELECT DISTINCT(title) FROM blog";
                                                ...
                                                <select class="form-select" id="autoSizingSelect" name="title" require>
                                        ...
                                        <h2 class="p-5 text-center">Your Blog Report</h2>
                                            ...
                                            <table class="table p-3" id="tblData">
                                                <thead>
                                                    ...
                                                    if (isset($_POST['submit'])) {
                                                        ...
                                                        $query = "select * from blog where title = '$title' AND email = '$email'";
                                                    ...
                                                    ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="blog_update.php?ids=<?php echo $row['ID']; ?>" class="btn btn-primary">Update Blog</a> </td>
                                                                </tr>
                                                            <?php
                                                            } else {
                                                                echo "No Request";
