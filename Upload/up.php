                        ...
                        if (in_array($filechk2, $fileextstore2)) {
                            ...
                            if (in_array($filechk3, $fileextstore3)) {
                                ...
                                if (in_array($filechk4, $fileextstore4)) {
                                    ...
                                    $insertquery = "INSERT INTO pakages( Continents, Country, Min_Age, Diff, Type, Days, pic_1, pic_2, pic_3, pic_4) VALUES ('$continents','$country','$min_age', '$difficulty','$type','$days','$destinationd','$destinationd2','$destinationd3','$destinationd4')";
