                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <h3 class="text-center mt-2">Post The Blog</h3>
                            <div class="col-md-10 pt-3 pb-5">
                                ...
                                <div class="col-mb-5">
                                        <label for="exampleInputEmail1" class="form-label">Blog_ID</label>
                                    ...
                                    <div class="col-mb-5">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="title" value="<?php echo $row['title']; ?>">
                                    </div>
                                    <div class="col-mb-5">
                                        <label for="exampleInputEmail1" class="form-label">Bloger_Name</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name" value="<?php echo $row['name']; ?>" readonly>
                                    </div>
                                    <div class="col-mb-5">
                                        <label for="exampleInputEmail1" class="form-label">Bloger_email</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php echo $row['email']; ?>" readonly>
                                    </div>
                                    <!-- <div class="col-md-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="short_des"
                                        value="<?php echo $row['short_des']; ?>"><?php echo $row['short_des']; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Long Description</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="13" name="long_des"
                                        value="<?php echo $row['short_des']; ?>"><?php echo $row['long_des']; ?></textarea>
                                    </div>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    //                 move_uploaded_file($filetemp4, $destination4);
                                                    ...
                                                    $update="UPDATE blog SET title='$title',name='$name',email='$email',short_des='$short_des',long_des='$long_des' WHERE ID='$ID_S'";
                                ...
                                ?>
                                                        <script>
                                                            ...
                                                            window.location.href = "blog-view.php";
                                                        </script>
                                                    <?php
                                                    } else {
                                                    ?>
